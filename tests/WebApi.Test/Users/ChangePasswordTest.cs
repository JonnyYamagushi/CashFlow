...
public class ChangePasswordTest : CashFlowClassFixture
{
    ...
    public async Task Success()
    {
        ...
        response = await DoPost(METHOD_LOGIN, loginRequest);
    ...
    public async Task Error_Password_Different_Current_Password(string culture)
    {
        ...
        var expenctedMessage = ResourceErrorMessages.ResourceManager.GetString("PASSWORD_DIFFERENT_CURRENT_PASSWORD", new CultureInfo(culture));
